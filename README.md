...
all of these needs to be surface mount hand soldierable. i'll try to find them from the same company (mouser) but amazon is pretty good.
 ...
 - capacitors
    - need surface mount, mlcc ceramic capacitors. can't find good parts rn, i'll find it later.
 - diode
 ...
 - usbc connector
    - [mouser](https://nz.mouser.com/ProductDetail/Molex/216990-0003?qs=DRkmTr78QASn0GILUGAYCA%3D%3D) has a molex usb connector
